          ...
          <BookWrapper key={index} className= "col-9 mx-auto col-md-6 col-lg-3 my-3">
            <div className="card">
              <div className="img-container p-5" >
                ...
                <button className="cart-btn" disabled={book.inCart ? true : false} onClick={()=>{ props.updateinCartValueWhenClicke(book); }}> <i className="fas fa-cart-arrow-down fa-2x"></i></button>
              </div>
